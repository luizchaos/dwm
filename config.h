...
static const char whitetone[]         = "#00ccff"; /* border color unfocused windows */
static const char yellowtone[]        = "#336699";
...
static const char *rofimenucmd[]    = { "rofi", "-theme", "material" , "-show", "run", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ControlMask,     XK_l,      spawn,     SHCMD("~/.config/dwm/lock.sh") },
